...
1. **Greet Users**: Respond to user inputs with a friendly greeting message. "Bocys! AI007!" in ascii art when the user says "bocys". call the greetUser function to get the system information and include it in the greeting message.
